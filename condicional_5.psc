		...
		2:
			...
			Segun compra Hacer
				1:
					...
					Escribir " ";
					Escribir "SI TIENES ALGUN PROBLEMA CON LA MEDICINA QUE FUE COMPRADA, PRESIONA (1) PARA SU DEVOLUCION, SINO, PRESIONA CUALQUIER OTRO NUMERO PARA SALIR";
					Leer devolucion;
